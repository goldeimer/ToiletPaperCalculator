<template>
  <div class="container is-max-widescreen">
    ...
    <section class="section is-medium">
      ...
      <h2>Du brauchst pro Monat {{ this.rollsPerMonth }} Rollen Goldeimer Klopapier</h2>
    ...
    <section class="section is-small">
      ...
      <p>
        ...
        <b-tooltip
          label="FÖP-Daten auf Basis der Ökobilanzen des Umweltbundesamtes (2000) und des IFEU Instituts (2008) sowie des 2. Entwurf des BVT(Beste verfügbare Techniken)-Merkblattes für die Zellstoff und Papierherstellung (D2), 16 2012, http://eippcb.jrc.es/reference/"
          position="is-top"
          size="is-large"
          multilined>
          <b-button label="info" type="is-dark" />
